...
using RepoAIfyApp.Helpers.Serilog;
using RepoAIfyApp.Services;
using RepoAIfyApp.ViewModels;
using RepoAIfyApp.Views;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddTransient<RepoAIfyLib.Services.OptionsLoaderService>();
        services.AddTransient<RepoAIfyLib.Services.FileProcessorService>();
        services.AddTransient<ConverterRunnerService>();
        services.AddTransient<Func<int, RepoAIfyLib.Services.MarkdownGeneratorService>>(provider =>
            (maxChunkSizeKb) => new RepoAIfyLib.Services.MarkdownGeneratorService(
                provider.GetRequiredService<Microsoft.Extensions.Logging.ILogger<RepoAIfyLib.Services.MarkdownGeneratorService>>(),
                maxChunkSizeKb
            ));
    }
